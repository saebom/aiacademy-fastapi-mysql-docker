...
class Quiz(object):
    ...
    def id(self):
        ...
        # return [ "".join(a) for i in range(10)]

        return [ "".join([random.choice(string.ascii_letters) 
                          for i in range(5)]) for i in range(10)] # 와 동일
    ...
    '''
    def quiz5(self, subject) :
        scores = self.quiz4()
        ic(scores.loc[:,subject])    # 행, 열 기준 열 추출
    ...
    def quiz6(self, id) :
        ...
        scores = self.quiz4()
        ic(scores.iloc[[0],:])  # i는 index를 의미, 행 추출
